...
export class ModelUtils {
    static setShapePosition(history: History, model: DiagramModel, shape: Shape, newPosition: Point,
        includeChildren: boolean = true): boolean {
    ...
    static setShapeSize(history: History, model: DiagramModel, shape: Shape, newPosition: Point, newSize: Size): boolean {
    ...
    static changeShapeType(history: History, model: DiagramModel, shape: Shape, shapeType: string): boolean {
        if(shape.description.key === shapeType) return false;
        history.beginTransaction();
