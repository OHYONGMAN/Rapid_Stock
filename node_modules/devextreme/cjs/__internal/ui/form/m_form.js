...
const Form = _ui2.default.inherit({
    ...
    _getGroupColCount: $element => parseInt($element.attr(_constants.GROUP_COL_COUNT_ATTR)),
    ...
    _refresh() {
        _events_engine.default.trigger(this.$element().find(".dx-state-focused > :not(.dx-dropdowneditor-input-wrapper) input, .dx-state-focused textarea"), "change");
        this.callBase()
    },
