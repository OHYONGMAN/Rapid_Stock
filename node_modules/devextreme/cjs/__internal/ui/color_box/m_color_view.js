...
const ColorView = _editor.default.inherit({
    ...
    _renderHtmlCellInsideRow: (index, $rowParent, additionalClass) => (0, _renderer.default)("<div>").addClass(COLOR_VIEW_CELL_CLASS).addClass(additionalClass).appendTo($rowParent.find(`.${COLOR_VIEW_ROW_CLASS}`).eq(index)),
    _renderPalette() {
